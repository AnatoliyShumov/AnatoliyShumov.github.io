            ...
            <Wrapper>
                <ContentWrapper>
                    ...
                    <MenuWrapper open={menuOpen}>
                        <MenuLink>
                            <a onClick={() => this.scrollTo('About')} href="#About">About me</a>
                            <a onClick={() => this.scrollTo('Relationships')} href="#Relationships">Relationships  </a>
                            <a onClick={() => this.scrollTo('Requirements')} href="#Requirements">Requirements</a>
                            <a onClick={() => this.scrollTo('Users')} href="#Users">Users</a>
                            <a onClick={() => this.scrollTo('RegisterNewUser')} href="#RegisterNewUser'" >Sign Up</a>
                            {window.innerWidth <= 1024 ? <a href="#SignAut">Sign Aut</a> : " "}
                        </MenuLink>
                        <User>
                            <div>
                                <p>{position}</p>
