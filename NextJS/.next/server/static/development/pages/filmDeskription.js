...
function FilmDescription(props) {
  ...
  return __jsx(Wrapper, {
    ...
    __self: this
  }, react_html_parser__WEBPACK_IMPORTED_MODULE_5___default()(showFilm.summary))));
}
...
`;
const ContentWrapper = styled_components__WEBPACK_IMPORTED_MODULE_4___default.a.div`
  display: flex;
  flex-wrap: wrap-reverse;
  margin: 0 40px;
`;
const FilmWrapper = styled_components__WEBPACK_IMPORTED_MODULE_4___default.a.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  width: 30%;
`;
const FilmAbout = styled_components__WEBPACK_IMPORTED_MODULE_4___default.a.div`
  display: flex;
  flex-direction: column;
  width: 70%;
  padding-top: 130px;
`;
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])(mapStateToProps, mapDispatchToProps)(FilmDescription));
...
const withShowFilm = id => {
  return dispatch => {
    const queryToUrl = id;
    const url = `http://api.tvmaze.com/shows/${queryToUrl}`;
    axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(url).then(({
      data
    }) => {
      if (data) {
...
/***/ 3:
/*!****************************************!*\
  !*** multi ./pages/filmDeskription.js ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/pro/Desktop/test-task/next-js/with-redux-thunk-app/pages/filmDeskription.js */"./pages/filmDeskription.js");
...
/******/ });
//# sourceMappingURL=filmDeskription.js.map