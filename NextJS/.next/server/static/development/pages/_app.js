...
function getOrCreateStore(initialState) {
  ...
  if (isServer) {
    return Object(_redux_store_store__WEBPACK_IMPORTED_MODULE_9__["initializeStore"])(initialState);
  } // Create store if unavailable on the client and set it on the window object


  if (!window[__NEXT_REDUX_STORE__]) {
    window[__NEXT_REDUX_STORE__] = Object(_redux_store_store__WEBPACK_IMPORTED_MODULE_9__["initializeStore"])(initialState);
  }
...
const CLEAR_INPUT_VALUE = 'CLEAR_INPUT_VALUE';
...
function reducer(state = initialState, action) {
  switch (action.type) {
    case _actions_action_types__WEBPACK_IMPORTED_MODULE_7__["SEARCH"]:
      {
        const {
          value
        } = action;
    ...
    case _actions_action_types__WEBPACK_IMPORTED_MODULE_7__["GET_SEARCH_SUCCESS"]:
      {
    ...
    case _actions_action_types__WEBPACK_IMPORTED_MODULE_7__["CLEAR_INPUT_VALUE"]:
      {
        return _objectSpread({}, state, {
          value: ''
        });
